...
use core::{cmp::{max, min}, fmt::Write};

use alloc::format;

use embedded_graphics::{framebuffer::Framebuffer, geometry::{Angle, Point, Size}, mono_font::MonoTextStyle, pixelcolor::{raw::{BigEndian, RawU16}, Rgb565}, primitives::{Arc, Circle, Line, PrimitiveStyle, PrimitiveStyleBuilder, Rectangle, StyledDrawable}, text::Text, Drawable};
use heapless::String;
